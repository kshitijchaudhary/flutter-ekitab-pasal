          ...
          Positioned(
            ...
            child: FadeAnimation(1.2, Container(
              ...
              child: Transform.translate(
                offset: Offset(30, -30),
                child: FadeAnimation(1.3, Image.asset('assets/logo.png',)),
              ),
            )),
          ),
          Positioned(
            ...
            child: FadeAnimation(1.2, Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    FadeAnimation(1.3, Text('Science X', 
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                            Text('\$2/month.', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold),),
                            Text('12', style: TextStyle(color: Colors.white, )),
                          ],),
                          Text('Hire Now', style: TextStyle(color: Colors.white, fontSize: 25),),
                        ],
                      ),
                    )),
                    SizedBox(height: 50,),
