      ...
      child: Row(
       ...
       child:ListView.builder(
        ...
        itemBuilder: (context, index){
          return TimelineBrowseBook(this.widget.bookList[index].name,this.widget.bookList[index].photo,this.widget.bookList[index].rentPrice,this.widget.bookList[index].authorName,);
        },
      ),
